...
def performDetect(imagePath, thresh, configPath , weightPath , metaPath,outPath):
    ...
    for i in range(0,len(imagenames)):
        ...
        for detection in detections:
            label = detection[0]+''+str(detection[1])
            confidence = detection[1]
        ...
        io.imsave(outPath+str(i).zfill(6)+'.jpg',image)
...
if __name__ == "__main__":
    ...
    imagePath="data/obj2_concat/"
    outPath="data/obj3_out/"
    thresh= 0.25
    configPath = "cfg/yolov3-tiny_obj.cfg"
    weightPath = "backup/yolov3-tiny_obj_120100.weights"
    metaPath= "data/obj.data"
 #   configPath = "YoloFD/yolo-face.cfg"
 #   weightPath = "YoloFD/yolo-face_final.weights"
 #   metaPath= "YoloFD/face.data"
